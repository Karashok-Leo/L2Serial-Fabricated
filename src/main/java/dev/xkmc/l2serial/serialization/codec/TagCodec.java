...
public class TagCodec
{
     ...
     */
    @Nullable
    public static <T> T fromTag(NbtCompound tag, Class<?> cls)
    {
    ...
    public static <T> T fromTag(NbtCompound tag, Class<?> cls, @Nullable T obj, Predicate<SerialClass.SerialField> pred)
    {
     ...
     */
    @Nullable
    public static NbtCompound toTag(NbtCompound tag, Object obj)
    {
     ...
     */
    @Nullable
    public static NbtCompound toTag(NbtCompound tag, Class<?> cls, Object obj)
    {
     ...
     */
    @Nullable
    public static NbtCompound toTag(NbtCompound tag, Class<?> cls, Object obj, Predicate<SerialClass.SerialField> pred)
    {
    ...
    @Nullable
    @SuppressWarnings("unchecked")
    public static <T> T valueFromTag(NbtElement tag, Class<?> cls, Predicate<SerialClass.SerialField> pred)
    {
     ...
     */
    @Nullable
    public static NbtElement valueToTag(Class<?> cls, Object obj, Predicate<SerialClass.SerialField> pred)
    {
     ...
     */
    @Nullable
    public static <T> T valueFromTag(NbtElement tag, Class<?> cls)
    {
     ...
     */
    @Nullable
    public static NbtElement valueToTag(Object obj)
    {
